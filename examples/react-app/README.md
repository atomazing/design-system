...
- Dev: `pnpm -C examples/react-app dev`
- Build: `pnpm -C examples/react-app build`

## What to look at

- Surface styling should come from the active preset and MUI overrides, not app-local gradients or decorative panel chrome.
